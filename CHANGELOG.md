...
- Internal events gating and sampling for vwo_fmeSdkInit, vwo_sdkUsageStats, and vwo_sdkDebug to reduce internal event volume.

## [1.56.0] - 2026-08-07

### Changed

- Updated `wingify/wingify-fme-php-sdk` dependency to `^2.11.0`.

## [1.55.0] - 2026-06-29

### Changed

- Updated `wingify/wingify-fme-php-sdk` dependency to `^2.5.0` to support new user tracking capabilities.

## [1.50.0] - 2026-05-30

### Added

- Refactored to use Wingify package as a dependency.

## [1.23.1] - 2026-05-07

### Fixed

- Fixed the syntax to support php@7.0
...
- Added local bucketing support with `bucketingSeed`. This allows consistent bucketing logic across different SDKs or user identifiers.

```php
$context = [
    'id' => 'user_id',
    'bucketingSeed' => 'seed_value', // Optional: Use this value for bucketing
];

$flag = $vwoClient->getFlag('feature_key', $context);
```
